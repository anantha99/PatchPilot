...
class FakeModelClient(ModelClient):
    ...
    def _script(self, state: Any) -> list[tuple[str, dict[str, Any], str]]:
        ...
        return [
            ...
            ("memory_eval.summarize_context", {"observations": ["source fix applied", "targeted tests passed", "full tests passed"], "max_chars": 1000}, "compact context"),
            ("memory_eval.retrieve_artifacts", {"keys": ["patch_plan", "subagents", "phases"]}, "retrieve structured artifacts"),
            ("memory_eval.mark_phase", {"phase": "report"}, "start report phase"),
